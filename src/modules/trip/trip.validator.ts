...
export const TripValidation = {
  ...
  updateTripValidation: Joi.object()
    .keys({
      ...
      driver_rating: tripSchema.driverRatingRule.optional(),
      user_rating: tripSchema.userRatingRule.optional(),
      driver_feedback: tripSchema.driverFeedbackRule.optional(),
      user_feedback: tripSchema.userFeedbackRule.optional(),
