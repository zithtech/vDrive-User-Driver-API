...
import { RideType, ServiceType, BookingType, TripStatus, CancelBy, CancelReason } from '../../enums/trip.enums';
  ...
  async updateTrip(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const updateTripData: Partial<Trip> = {
        ...
        driver_rating: req.body.driver_rating,
        user_rating: req.body.user_rating,
        driver_feedback: req.body.driver_feedback,
