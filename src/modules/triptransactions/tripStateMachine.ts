...
export const FIELD_CHANGE_RULES: FieldChangeRule[] = [
  ...
  },
  {
    ...
    toValue: TripStatus.Waiting,
    event: TripEventType.TripWaiting,
    actor: ActorType.System, // Or Driver
    priority: 100,
    description: 'Driver reached destination and is waiting',
  },
  {
    field: 'trip_status',
    toValue: TripStatus.DayHalt,
    event: TripEventType.TripDayHalt,
    actor: ActorType.Driver,
    priority: 100,
    description: 'Driver halted trip for the day',
  },
  {
    field: 'trip_status',
    toValue: TripStatus.ReturnStarted,
  ...
  },
  {
    ...
    actor: ActorType.Driver,
    priority: 100,
    description: 'Driver reached the return destination',
  },
  {
    field: 'trip_status',
